    ...
    <div style={{ width, height, position: 'relative', overflow: 'hidden', background: `linear-gradient(to bottom, ${m.skyA}, ${m.skyB})` }}>
      {mood === 'golden' && <>
        ...
        <div style={{ position: 'absolute', bottom: 0, left: '8%' }}>
          <div style={{ width: 5, height: 22, background: 'oklch(27% 0.09 118)', margin: '0 auto' }} />
          <div style={{ width: 26, height: 32, borderRadius: '50% 50% 36% 36%', background: 'oklch(31% 0.11 130)', marginTop: -16, marginLeft: -10 }} />
        </div>
      </>}
      {mood === 'cloudy' && <>
        {[0, 1, 2].map(i => (
